...
const plans: PlanRow[] = [
  ...
  },
  {
    ...
    contras: "Requiere 40% de inicial en 6 pagos + pre-entrega",
    href: "#mas-planes",
  },
  {
    id: "ruta66",
    ...
    requisitosExtra: false,
    entregaAnticipada: false,
    pros: "Cuotas bajas con el plazo más largo del catálogo",
    contras: "16 cuotas iniciales y pre-entrega antes de recibir el vehículo",
    href: "#mas-planes",
  },
  {
    id: "travesia",
  ...
  },
  {
    ...
    requisitosExtra: false,
    entregaAnticipada: false,
    pros: "Tres pagos iguales: firma, 30 días y previo a la entrega",
    contras: "Exige gran disponibilidad de capital inmediato",
    href: "#mas-planes",
  },
  {
    id: "bel",
