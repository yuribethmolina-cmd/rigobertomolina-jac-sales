...
const pasajeros: CatalogModel[] = [
  ...
  { name: "Limited", image: "https://jacvenezuela.com/wp-content/uploads/2024/09/t9-Aventura-Gasolina-jac-motors-venezuela-1024x427.jpg", tagline: "Pickup edición limitada — consulta disponibilidad", priceCD: "Consultar", pricePF: "Consultar", referentialImage: true },
  ...
  { name: "RF8", image: "https://jacvenezuela.com/wp-content/uploads/2025/06/JAC-REFINE-EN-VENEZUELA-1024x427.jpg", tagline: "SUV insignia — consulta disponibilidad", priceCD: "Consultar", pricePF: "Consultar", referentialImage: true },
  ...
  { name: "La Venezolana a Diésel 4×2 y 4×4", image: "https://jacvenezuela.com/wp-content/uploads/2025/02/jac_banners_la_venezolana_diesel_4x2_4x4-1024x427.jpg", tagline: "Mayor eficiencia para trabajo pesado", priceCD: "$3.278/mes", pricePF: "$1.840/mes", fichaUrl: "https://jacvenezuela.com/portfolio/la-venezolana-diesel/" },
  ...
  { name: "GX7", image: "https://jacvenezuela.com/wp-content/uploads/2026/06/GX7-1-1.png", tagline: "SUV 180 HP Turbo 7DCT · Cámara 360° · Techo panorámico", priceCD: "$4.407/mes", pricePF: "$2.212/mes", featured: "NUEVO", fichaUrl: "https://jacvenezuela.com/espera-termino-jac-presenta-el-gx7/" },
  ...
  { name: "Sunray V4 Pasajeros", image: "https://jacvenezuela.com/wp-content/uploads/2025/03/SUNRAY-V6-171-1024x427.webp", tagline: "Van V4 para transporte de pasajeros", priceCD: "Consultar", pricePF: "Consultar", referentialImage: true },
  { name: "Sunray V4 Carga", image: "https://jacvenezuela.com/wp-content/uploads/2025/03/SUNRAY-V6-CARGA-1-1024x425.webp", tagline: "Van V4 para carga", priceCD: "Consultar", pricePF: "Consultar", referentialImage: true },
  ...
  { name: "Sunray V6 Van Escolar", image: "https://jacvenezuela.com/wp-content/uploads/2025/03/SUNRAY-V6-171-1024x427.webp", tagline: "Van escolar — consulta disponibilidad", priceCD: "Consultar", pricePF: "Consultar", referentialImage: true },
];
...
const camiones: CatalogModel[] = [
  ...
  { name: "Búfalo Cava de Conservación", image: "https://jacvenezuela.com/wp-content/uploads/2025/03/BUFALO-1024x425.webp", tagline: "Cava térmica para cadena de frío", priceCD: "Consultar", pricePF: "Consultar", referentialImage: true },
  { name: "Búfalo Brazo Hidráulico", image: "https://jacvenezuela.com/wp-content/uploads/2025/03/BUFALO-1024x425.webp", tagline: "Brazo hidráulico para carga pesada", priceCD: "Consultar", pricePF: "Consultar", referentialImage: true },
  ...
  { name: "Leyenda 380 HP", image: "https://jacvenezuela.com/wp-content/uploads/2025/03/LEYENDA-1024x425.webp", tagline: "Versión de mayor potencia — consulta disponibilidad", priceCD: "Consultar", pricePF: "Consultar", referentialImage: true },
...
const utilitarios: CatalogModel[] = [
  ...
  { name: "Compactador 10M3", image: "https://jacvenezuela.com/wp-content/uploads/2025/03/Compactador-5-ton-1024x425.webp", tagline: "Compactador de mayor capacidad — consulta disponibilidad", priceCD: "Consultar", pricePF: "Consultar", referentialImage: true },
