    ...
    <div className="section-container">
      <div className="text-center">
        ...
        <p className="section-subtitle">
          ...
          adicionales para que encuentres la modalidad que mejor se adapta a tu
          presupuesto.
        </p>
      ...
      <p className="mt-8 text-center text-xs text-muted-foreground max-w-2xl mx-auto leading-relaxed">
        * Montos referenciales de los catálogos oficiales JAC / Bel Feb 2026.
        Sujetos a variación según modelo, flete, seguro, IVA, IGTF y gastos de
        nacionalización. Confirma siempre con Rigoberto antes de cerrar tu plan.
      </p>
    </div>
  </section>
);
