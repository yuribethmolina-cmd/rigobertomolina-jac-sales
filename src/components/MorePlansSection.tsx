...
const morePlans: Plan[] = [
  ...
  },
  {
    ...
    inicialRange: "Inicial fraccionada desde $2.922,2 hasta $9.290,8 (3 pagos)",
    highlight: "El plan más corto: paga en 6 cuotas",
    accent: "neutral" as const,
    models: [
      { model: "Arena Sport MT", cuota: 1785.7 },
      { model: "Arena Sport AT", cuota: 1952.4 },
      { model: "Arena Pro", cuota: 2150.8 },
      { model: "Nevado MT", cuota: 2428.5 },
      { model: "Tepuy Pro", cuota: 3420.2 },
      { model: "Savanna", cuota: 3301.2 },
      { model: "RF8", cuota: 5514.8 },
      { model: "GX7", cuota: 3102.8 },
      { model: "La Venezolana 4X2 Gasolina", cuota: 2560.7 },
      { model: "La Venezolana 4X2 Diesel 2.8L", cuota: 2446.3 },
      { model: "La Venezolana 4X4 Diesel 2.8L", cuota: 2837.2 },
      { model: "T5 La Venezolana 4X2 Diesel 2.8L", cuota: 2334.2 },
      { model: "La Venezolana Pal Campo 4X4 Diesel", cuota: 3251.2 },
      { model: "La Venezolana Pro 4X4", cuota: 3161.5 },
      { model: "Pickup Limited Automatica", cuota: 4011.5 },
      { model: "Aventura 4X4 Automatica", cuota: 3892.5 },
      { model: "Aventura Pro Gasolina Edicion Limitada", cuota: 4717.6 },
      { model: "X100 Ferretero", cuota: 2186.6 },
      { model: "Urban Chasis 3 Ton", cuota: 2504.1 },
      { model: "Urban Ferretero 3 Ton", cuota: 2662.7 },
      { model: "C-3500 4X4", cuota: 3686.2 },
      { model: "Doble Cabina Ferretero 3 Ton", cuota: 3138.8 },
      { model: "6T Chasis", cuota: 3563.8 },
      { model: "6T Ferretero", cuota: 3762.1 },
      { model: "Bufalo 12 Ton Tanque 1000 L", cuota: 5677.7 },
    ],
    inicialPct: 30,
    cuotasOrdinarias: 6,
    defaultPlazo: 6,
  ...
  },
  {
    ...
    models: [
      ...
      { model: "Arena Pro", cuota: 8087.7 },
      { model: "Nevado MT", cuota: 8915.2 },
      { model: "Tepuy Pro", cuota: 12221.5 },
      { model: "Savanna", cuota: 13098.2 },
      { model: "RF8", cuota: 20389.1 },
      { model: "GX7", cuota: 11724.9 },
      { model: "La Venezolana 4X2 Gasolina", cuota: 8831.0 },
      { model: "La Venezolana 4X2 Diesel 2.8L", cuota: 9111.8 },
      { model: "La Venezolana 4X4 Diesel 2.8L", cuota: 10182.5 },
      { model: "T5 La Venezolana 4X2 Diesel 2.8L", cuota: 9013.7 },
      { model: "La Venezolana Pal Campo 4X4 Diesel", cuota: 11474.6 },
      { model: "La Venezolana Pro 4X4", cuota: 12029.3 },
      { model: "Pickup Limited Automatica", cuota: 14898.8 },
      { model: "Aventura 4X4 Automatica", cuota: 14656.5 },
      { model: "Aventura Pro Gasolina Edicion Limitada", cuota: 18123.3 },
      { model: "X100 Ferretero", cuota: 6621.0 },
      { model: "Urban Chasis 3 Ton", cuota: 9116.5 },
      { model: "Urban Ferretero 3 Ton", cuota: 9655.7 },
      { model: "C-3500 4X4", cuota: 13189.7 },
      { model: "Doble Cabina Ferretero 3 Ton", cuota: 10790.0 },
      { model: "Bufalo 12 Ton Tanque 1000 L", cuota: 20060.9 },
      { model: "Bufalo XL Toma de Fuerza", cuota: 21101.2 },
      { model: "Leyenda 340 HP Tanque 1225 L 20 Ton", cuota: 28869.7 },
    ],
    inicialPct: 33,
    cuotasOrdinarias: 3,
    defaultPlazo: 3,
